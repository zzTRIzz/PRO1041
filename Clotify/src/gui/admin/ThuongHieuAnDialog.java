 ...
 * @author Ngo Nhan
 */
public class ThuongHieuAnDialog extends javax.swing.JDialog {
    ...
    public ThuongHieuAnDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThuongHieuAnDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ThuongHieuAnDialog dialog = new ThuongHieuAnDialog(new javax.swing.JFrame(), true);
