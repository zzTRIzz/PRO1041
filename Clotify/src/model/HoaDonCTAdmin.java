...
public class HoaDonCTAdmin {
    ...
    public HoaDonCTAdmin(int idHoaDonCT, int idSP, int soLuongMua, int khuyeMaiGia, int khuyenMaiPT, String tenSP, String tenKM, String maHD, String maNV, String ngayTao, String tenKH, String ctMaSP, String ctTenSP, double giaBan, double tongTien) {
